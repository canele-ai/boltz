...
def main(
    ...
    Usage:
        modal run orbits/eval-v2-winner/eval_stacked.py --mode sanity
        modal run orbits/eval-v2-winner/eval_stacked.py --mode eval --config '{"sampling_steps": 20, "recycling_steps": 0, "gamma_0": 0.0}'
        modal run orbits/eval-v2-winner/eval_stacked.py --mode eval --config-name ODE-20/0r+TF32 --validate
        modal run orbits/eval-v2-winner/eval_stacked.py --mode sweep --validate
    """
    if validate:
        num_runs = 3
