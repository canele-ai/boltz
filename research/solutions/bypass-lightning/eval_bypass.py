...
Usage:
    # Sanity check
    modal run research/solutions/bypass-lightning/eval_bypass.py --mode sanity

    # Single eval (1 run)
    modal run research/solutions/bypass-lightning/eval_bypass.py --mode eval

    # Validation (3 runs for stable timing)
    modal run research/solutions/bypass-lightning/eval_bypass.py --mode eval --validate

    # Compare with and without warmup
    modal run research/solutions/bypass-lightning/eval_bypass.py --mode sweep
"""
...
def main(
    ...
    Usage:
        ...
        modal run research/solutions/bypass-lightning/eval_bypass.py --mode eval
        modal run research/solutions/bypass-lightning/eval_bypass.py --mode eval --validate
        modal run research/solutions/bypass-lightning/eval_bypass.py --mode eval --use-trainer
        modal run research/solutions/bypass-lightning/eval_bypass.py --mode sweep --validate
    """
    if validate:
        num_runs = 3
